...
系统同步采集绘画过程数据（情绪变化、色彩偏好、笔触节奏、专注区域），由通义千问 VL 生成疗愈观察报告。
...
<table>
<tr>
<td align="center" width="16%"><img src="./public/master/monet/image.png" width="60" /><br /><strong>莫奈</strong><br /><sub>印象派</sub></td>
<td align="center" width="16%"><img src="./public/master/vangogh/image.png" width="60" /><br /><strong>梵高</strong><br /><sub>后印象派</sub></td>
<td align="center" width="16%"><img src="./public/master/gauguin/image.png" width="60" /><br /><strong>高更</strong><br /><sub>后印象派</sub></td>
<td align="center" width="16%"><img src="./public/master/rembrandt/image.png" width="60" /><br /><strong>伦勃朗</strong><br /><sub>巴洛克</sub></td>
<td align="center" width="16%"><img src="./public/master/picasso/image.png" width="60" /><br /><strong>毕加索</strong><br /><sub>立体主义</sub></td>
<td align="center" width="16%"><img src="./public/master/sargent/image.png" width="60" /><br /><strong>萨金特</strong><br /><sub>水彩</sub></td>
</tr>
<tr>
...
| 👁️ **先看后做** | 每笔先演示一遍再让孩子画（ABA 建模学习） |
| 💨 **情绪检测** | 连续失败/空闲时自动触发平静呼吸引导 |
| 📖 **社交故事** | 首次使用前6页图文引导（Carol Gray 标准） |
| 👤 **照护者提示** | 给旁边家长/治疗师的动态指导语 |
| 😊 **情绪前后测** | 量化每次绘画的情绪变化 |
| 📝 **主题引导** | 5 种低门槛分步绘画引导 |
| 👀 **共同注意** | 暂停问颜色/位置/情感联想，带大师知识反馈 |
| 🎯 **童趣按钮** | 所有操作图标化，降低文字阅读门槛 |
...
| 层 | 技术 | 用途 |
|:---:|------|------|
| 🖥️ | **Next.js 16** | App Router + API Routes |

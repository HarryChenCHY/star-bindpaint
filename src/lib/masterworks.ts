...
export const MASTER_ARTISTS: MasterArtist[] = [
  ...
  },
  {
    ...
    works: [
      { id: 'tahitian_women', title: '塔希提女人', titleEn: 'Tahitian Women', year: '1891', image: '/masterworks/gauguin/tahitian_women.jpg' },
      { id: 'yellow_christ', title: '黄色基督', titleEn: 'The Yellow Christ', year: '1889', image: '/masterworks/gauguin/yellow_christ.jpg' },
      { id: 'spirit_of_dead', title: '亡灵注视', titleEn: 'Spirit of the Dead Watching', year: '1892', image: '/masterworks/gauguin/spirit_of_dead.jpg' },
  ...
  },
  {
    ...
    works: [
      ...
      { id: 'anatomy_lesson', title: '解剖课', titleEn: 'The Anatomy Lesson', year: '1632', image: '/masterworks/rembrandt/anatomy_lesson.jpg' },
      { id: 'storm_on_galilee', title: '加利利海上的风暴', titleEn: 'Storm on the Sea of Galilee', year: '1633', image: '/masterworks/rembrandt/storm_on_galilee.jpg' },
  ...
  },
  {
    ...
    works: [
      { id: 'weeping_woman', title: '哭泣的女人', titleEn: 'The Weeping Woman', year: '1937', image: '/masterworks/picasso/weeping_woman.jpg' },
      { id: 'guernica_study', title: '格尔尼卡习作', titleEn: 'Guernica Study', year: '1937', image: '/masterworks/picasso/guernica_study.jpg' },
